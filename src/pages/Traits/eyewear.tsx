...
export const eyewear = {
  type: 'Eyewear',
  list: [
    { name: 'MORPHEUS', image: morpheus, rarity: 3.48 },
    { name: 'MISSION PASSED', image: missionPassed, rarity: 4.5 },
    { name: 'ELTON', image: elton, rarity: 4.74 },
    { name: 'SPORT GLASSES', image: sportGlasses, rarity: 4.98 },
    { name: 'LENNONS', image: lennons, rarity: 8.31 },
    { name: 'DEAL WITH IT', image: dealWithIt, rarity: 9.12 },
  ],
};
